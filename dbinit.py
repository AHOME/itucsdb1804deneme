...
INIT_STATEMENTS = [
    ...
    "CREATE TABLE STORE (STORE_ID SERIAL PRIMARY KEY, NAME VARCHAR(40) NOT NULL, PHONE VARCHAR(15) NOT NULL, ADRESS_ID INTEGER NOT NULL, EMAIL VARCHAR(50) UNIQUE NOT NULL, OPENEDDATE DATE NOT NULL, EXPLANATION VARCHAR(200) NOT NULL)",
