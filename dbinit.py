...
INIT_STATEMENTS = [
    "CREATE DOMAIN IF NOT EXISTS GENDERTYPE AS CHAR(1) CHECK ((VALUE = 'M') OR (VALUE = 'F') OR (VALUE = 'O'))",
    ...
    "CREATE TABLE STORE (STORE_ID SERIAL PRIMARY KEY, NAME VARCHAR(40) NOT NULL, PHONE INTEGER UNIQUE NOT NULL, ADRESS_ID INTEGER REFERENCES ADRESS (ADDRESS_ID), EMAIL VARCHAR(50) UNIQUE NOT NULL, OPENEDDATE DATE NOT NULL, EXPLANATION VARCHAR(200) NOT NULL)",
