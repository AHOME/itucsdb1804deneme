...
INIT_STATEMENTS = [
    ...
    "CREATE TABLE COMMENT (COMMENT_ID SERIAL PRIMARY KEY, CUSTOMER_ID INTEGER NOT NULL, TITLE VARCHAR(30) NOT NULL, EXPLANATION VARCHAR(200) NOT NULL, UPDATETIME DATETIME NOT NULL, POINTTOBOOK INTEGER NOT NULL)",
]
